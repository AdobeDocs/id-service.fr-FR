---
description: Les fonctions du service d’identification des visiteurs idSyncByURL et idSyncByDataSource vous permettent d’implémenter manuellement une synchronisation des identifiants dans l’iFrame de publication de destination. Elles sont disponibles dans VisitorAPI.js 1.10 ou version ultérieure.
...
Les fonctions du service d’identification des visiteurs idSyncByURL et idSyncByDataSource vous permettent d’implémenter manuellement une synchronisation des identifiants dans l’iFrame de publication de destination. Ils sont disponibles dans `VisitorAPI.js` version 1.10 ou ultérieure.
