...
En outre, les implémentations CNAME vous offrent la possibilité de **[!UICONTROL Choisir un type de collecte de données régionales personnalisé]**, qui détermine lʼemplacement où les accès des utilisateurs sont initialement dirigés. La plupart des clients nʼutilisent pas de type de collecte de données régionales personnalisé.
