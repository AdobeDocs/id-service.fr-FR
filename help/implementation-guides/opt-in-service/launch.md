...
Pour plus dʼinformations de référence, voir [Extension Opt-in pour Launch](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html).
