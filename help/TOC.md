...
+ Mise en œuvre {#implementation}
   ...
   + Service Opt-in {#opt-in-service}
      ...
      + [Contrôler les Activités des Experience Cloud en fonction du consentement de l’utilisateur](implementation-guides/opt-in-service/use-opt-in-to-control-experience-cloud-activities-based-on-user-consent.md)
