---
description: Experience Cloud Identity Service active la structure d’identification courante pour les applications et services Experience Cloud. Il fonctionne en attribuant à un visiteur ou une visiteuse du site un identifiant persistant et unique, appelé Experience Cloud ID (ECID).
...
Experience Cloud Identity Service active la structure d’identification courante pour les applications et services Experience Cloud. Il fonctionne en attribuant à un visiteur ou une visiteuse du site un identifiant persistant et unique, appelé Experience Cloud ID (ECID).
...
* **Experience Cloud Identity Service** : le service d’identités Experience Cloud Identity Service **est chargé de définir l’Experience Cloud ID (ECID)**. Pour plus d’informations, reportez-vous à la [Présentation d’Experience Cloud Identity Service](./introduction/overview.md).
