...
seo-title: Requête et définition d’ID par le service Experience Cloud ID
title: Requête et définition d’ID par le service Experience Cloud ID
...
# Requête et définition d’ID par le service Experience Cloud ID{#how-the-experience-cloud-id-service-requests-and-sets-ids}
...
>[!NOTE]
>
>Si vous ne savez pas comment le service Experience Cloud ID crée un identifiant visiteur, prenez quelques instants pour consulter la section [Experience Cloud](../mcvid-introduction/mcvid-cookies.md).
