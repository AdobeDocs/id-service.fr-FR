...
* Définit un cookie propriétaire dans le domaine du client afin d’assurer le tracking sur le domaine en question. Voir [Experience Cloud](../introduction/cookies.md).
