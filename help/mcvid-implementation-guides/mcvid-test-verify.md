...
seo-title: Test et vérification du service Experience Cloud ID
title: Test et vérification du service Experience Cloud ID
...
# Test et vérification du service Experience Cloud ID{#test-and-verify-the-experience-cloud-id-service}
...
La mise en œuvre de votre service est correctement configurée lorsqu’un [!DNL Experience Cloud ID] (MID) s’affiche dans la réponse du [!DNL Adobe] débogueur . Voir [Cookies et service Experience Cloud ID](../mcvid-introduction/mcvid-cookies.md) pour plus d’informations sur le MID.
